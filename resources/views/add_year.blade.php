                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" id="inputFirstName" type="text" name="year" placeholder="Enter year here" Required="required" />
                                                        <span class="small text-danger">{{ $errors->first('year') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group mt-4 mb-0">
                                            <input type="submit" name="add_year" value="Add Year Type" class="btn btn-primary btn-block">
                                            </div>
                                        </form>
                                    </div>
                                </div>
