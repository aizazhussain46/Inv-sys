                    ...
                    <div class="col-md-1 col-lg-1"></div>
                            <div class="col-sm-10 col-md-10 col-lg-10">
                                <div class="card border-0 rounded-lg mt-3">
                                    <div class="card-body">
                                        <form  method="POST" action="{{ url('devicetype/'.$devicetype->id) }}">
                                        @method('PUT')
                                        @csrf
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" type="text" name="devicetype_name" value="{{ $devicetype->devicetype_name }}" placeholder="Enter Devicetype here" Required="required" />
                                            ...
                                            <input type="submit" name="edit_devicetype" value="Edit Device Type" class="btn btn-primary btn-block">
                                            </div>
                                        </form>
                                    </div>
                                </div>
