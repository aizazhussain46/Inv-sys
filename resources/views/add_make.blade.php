                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" type="text" name="make_name" placeholder="Enter make name here" Required="required" />
                                                        <span class="small text-danger">{{ $errors->first('make_name') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group mt-4 mb-0">
                                            <input type="submit" name="add_make" value="Add Make" class="btn btn-primary btn-block">
                                            </div>
                                        </form>
                                    </div>
                                </div>
