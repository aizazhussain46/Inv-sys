                                            ...
                                            <div class="form-row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control py-4" id="inputFirstName" type="text" name="location" value="{{$location->location}}" placeholder="Enter location here" Required="required" />
                                                        <span class="small text-danger">{{ $errors->first('location') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group mt-4 mb-0">
                                            <input type="submit" name="update_location" value="Update Location" class="btn btn-primary btn-block">
                                            </div>
                                        </form>
                                    </div>
                                </div>
