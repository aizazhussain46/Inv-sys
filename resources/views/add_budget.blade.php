                                                ...
                                                <div class="form-row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control py-2" id="u_dollar" name="unit_dollar" type="number" placeholder="Enter unit price in $ here" />
                                                    ...
                                                    <div class="col-md-6">    
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control py-2" id="pkr" name="unit_pkr" type="number" placeholder="Enter unit price in pkr here" readonly />
                                                ...
                                                <div class="form-row">    
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control py-2" id="t_dollar" name="total_dollar" type="number" placeholder="Enter total price in $ here" readonly />
                                                    ...
                                                    <div class="col-md-6">    
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control py-2" id="t_pkr" name="total_pkr" type="number" placeholder="Enter total price in pkr here" readonly />
